...
// let readCsvFile = "Majors.csv"
// let csvFile = document.getElementById(readCsvFile)
// function myFunction(csvFile){
//     console.log(csvFile)
// }
...
function generateTerm(){
    let mn = 22018;
    let mx = 22022;
    let temp = Math.floor(Math.random() * (mx - mn + 1)) + mn;
    let array = [1,5,8];
    let generateSem =  Math.floor(Math.random() * array.length);
    let r1 = array[generateSem];
    let sum = "" + temp  + r1 ;
    return sum;  
}
